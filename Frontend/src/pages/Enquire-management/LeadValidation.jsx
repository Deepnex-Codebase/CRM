...
const LeadValidation = () => {
  // Sample data for leads requiring validation
  const [leads, setLeads] = useState([
    {
      ...
      status: 'pending',
      validation_issues: ['possible_duplicate', 'invalid_email'],
      duplicate_score: 85,
      potential_duplicates: ['LD005', 'LD012'],
      validation_score: 65
    },
    {
      id: 'LD002',
    ...
    },
    {
      ...
      status: 'rejected',
      validation_issues: ['spam_signals', 'fake_company'],
      duplicate_score: 20,
      potential_duplicates: [],
      validation_score: 30
    },
    {
      ...
      status: 'pending',
      validation_issues: ['incomplete_data'],
      duplicate_score: 25,
      potential_duplicates: [],
      validation_score: 75
    },
    {
      ...
      created_at: '2023-07-13T09:20:00',
      status: 'pending',
      validation_issues: ['possible_duplicate'],
      duplicate_score: 85,
      potential_duplicates: ['LD001'],
      validation_score: 80
    },
    {
      id: 'LD006',
  ...
  const handleValidationAction = (id, action) => {
    setLeads(prev => 
      prev.map(lead => 
  ...
  const completeMerge = () => {
    // Add the merged lead
    setLeads(prev => [
      ...prev.filter(lead => !selectedLeads.map(l => l.id).includes(lead.id)),
      mergedLead
    ]);
